...
interface Plan {
    ...
    duration: string;
    date_study: string;
    fee: string | { thai?: string; international?: string; group1?: string; group2?: string };
...
const ProgramCard: React.FC<ProgramCardProps> = ({ programKey, program }) => {
    ...
    const renderFee = (fee: string | object) => {
                    ...
                    {program.plans.map((plan, index) => (
                        <div key={index} className="border border-gray-200 rounded-lg p-5 hover:border-indigo-300 transition-colors bg-gray-50">
                            ...
                            <div className="mt-4 pt-4 border-t border-gray-200">
                                ...
                                <p className="text-sm text-gray-700 leading-relaxed">{renderQualification(plan.qualification)}</p>
                            </div>
                        </div>
                    ))}
                </div>
